...
export default {
  ...
  */
  ...
  setupDefaultRunSettingsUI(element){
    ...
    this.populateRunSettingsUI(defaultRootPath, defaultIndex, defaultMockImpl, false, "ios",null);
  },

  populateRunSettingsUI(rootFolder, indexFile, mockImpl, runOnPhysicalDev, emulatedOS,libraryLoader){
