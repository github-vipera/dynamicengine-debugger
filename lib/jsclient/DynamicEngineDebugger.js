  ...
  */
  ...
  __deDebuggerSocket.on('de_debug_nh_call', function(msg){
      ...
      } else if (msg.requestCommand === "Communicator.sendPreferenceValue") {
          DEDebuggerHandler.__sendPreferenceValue(msg);
      } else {
...
DEDebuggerHandler = {
  ...
  ___onDEBaseService_serviceResponse : function(message){
    ...
    __sendPreferenceValue:function(message){
      Communicator.sendPreferenceValue(message.params.key,message.params.value);
    }
